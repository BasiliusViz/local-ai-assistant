...
# У задач Jira и находок DefectDojo есть свои инструменты с фильтрами по
# полям, а лежат они в общей коллекции — без этого исключения поиск по
# документации возвращал бы вперемешку регламенты, тикеты и уязвимости, и на
# вопрос про Jira модель получала бы ответ из Confluence.
OWN_TOOL_SOURCES = ("jira", "dojo")
