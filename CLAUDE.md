...
код и граф, расширение запроса.

Написано, но на живом стенде **не проверялось**: Jira, DefectDojo, режим
пространств Confluence (`CONFLUENCE_SPACES`), `repos/sync.py` на живых
серверах.
